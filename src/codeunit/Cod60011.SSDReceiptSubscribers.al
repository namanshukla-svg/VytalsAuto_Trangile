codeunit 60011 "SSD Receipt Subscribers"
{
    ...
    begin
        ...
        if SSDQualityOrderHeader.FindSet()then repeat SSDQualityOrderHeader2.Get(SSDQualityOrderHeader."No.");
    ...
    begin
        ...
        if Item."SSD Item SubType" <> WarehouseReceiptHeader."SSD Material Type" then Error(ItemTypeMismatchErr, Item."SSD Item SubType", WarehouseReceiptHeader."No.");
    end;

codeunit 60008 "SSD Auttomation Subscribers"
{
    ...
    begin
        if WarehouseRequest.Type <> WarehouseRequest.Type::Inbound then exit;
        if WarehouseRequest."Source Document" = WarehouseRequest."Source Document"::"Sales Return Order" then
            if SalesHeader.Get(SalesHeader."Document Type"::"Return Order", WarehouseRequest."Source No.") then begin
        ...
        if WarehouseRequest."Source Document" = WarehouseRequest."Source Document"::"Purchase Order" then
            if PurchaseHeader.Get(PurchaseHeader."Document Type"::Order, WarehouseRequest."Source No.") then begin

codeunit 60009 "SSD Production Subscribers"
{
    ...
    begin
        ProductionBOMLine."SSD Consumption Station":=Item."SSD Consumption Station";
    end;
    ...
    begin
        ...
        if ProdBOMLine."SSD Consumption Station" <> ProdBOMLine."SSD Consumption Station"::" " then ProdOrderComp."SSD Consumption Station":=ProdBOMLine."SSD Consumption Station"
        else if Item.Get(ProdOrderComp."Item No.")then ProdOrderComp."SSD Consumption Station":=Item."SSD Consumption Station";
    end;

table 60009 "SSD Dock Planning"
{
    ...
    begin
        ...
        if WarehouseShipmentHeader.FindSet()then repeat WarehouseShipmentLine.SetRange("No.", WarehouseShipmentHeader."No.");
                WarehouseShipmentLine.SetRange("Item No.", SSDDockPlanning."Item No.");
                if WarehouseShipmentLine.FindSet()then repeat WarehouseShipmentLine."Pick Planned":=false;

table 60001 "SSD Dock Time Slots"
{
        ...
        field(20; "Starting Time"; Time)
        {
            ...
            begin
                if("Ending Time" = 0T) or ("Ending Time" < "Starting Time")then begin
                    ...
                    if ShopCalendar.FindFirst()then "Ending Time":=ShopCalendar."Starting Time"
                    else
                        "Ending Time":=235959T;
                end;
                CheckRedundancy();
    ...
    begin
        ...
        if ShopCalendar2.Find('-')then repeat TempShopCalendar:=ShopCalendar2;
    ...
    var ShopCalendar: Record "SSD Dock Time Slots";

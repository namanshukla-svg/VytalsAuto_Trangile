pageextension 60144 PostedOutGateEntry extends "Posted Outward Gate SubForm"
{
    ...
    actions
    {
        ...
        addfirst(Processing)
        {
            ...
            //         if DockLines.FindFirst() then
            //             if (DockLines.Status = DockLines.Status::Completed) or (DockLines.Status = DockLines.Status::"Dock Out") then
            //                 Error('Planning already fulfilled')
            //             else begin

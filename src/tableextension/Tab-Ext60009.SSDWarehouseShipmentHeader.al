tableextension 60009 "SSD Warehouse Shipment Header" extends "Warehouse Shipment Header"
{
    ...
    begin
        ...
        if WarehouseShipmentLine.FindSet()then repeat if WarehouseShipmentLine."SSD Dock No." <> "SSD Dock No." then WarehouseShipmentLine."SSD Dock No.":="SSD Dock No.";
                ...
                if WarehouseShipmentLine."SSD Material Type" <> "SSD Material Type" then WarehouseShipmentLine."SSD Material Type":="SSD Material Type";

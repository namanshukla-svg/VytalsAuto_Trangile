Report 60142 "SSD Posted MRN Automation IG"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/Posted MRN Automationn_IG.rdl';
    Caption = 'MRN 1 Automation IG';
        ...
        dataitem("Posted Whse. Receipt Header"; "Posted Whse. Receipt Header")
        {
            ...
            dataitem("Integer"; "Integer")
            {
                ...
                dataitem("Posted Whse. Receipt Line"; "Posted Whse. Receipt Line")
                {
                    ...
                    {
                        DataItemLink = "Document No."=field("Posted Source No."), "Item No."=field("Item No."); //IG_DS code commented by IG_RD, "Document Line No." = field("Line No.");

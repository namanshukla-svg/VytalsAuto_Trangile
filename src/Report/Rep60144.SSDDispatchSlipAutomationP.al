report 60144 "SSD Dispatch Slip Automation P"
{
    ...
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/SSD Dispatch Slip NewA Posted.rdlc';
            ...
            dataitem("Warehouse Shipment Line"; "Posted Whse. Shipment Line") // "Warehouse Shipment Line")
            {
                ...
                begin
                    ...
                    if ReservationEntry.FindSet() then
                        repeat
                            if not SSDtemporaryDisppack.Get(ReservationEntry."Document No.", ReservationEntry."Item No.", ReservationEntry."Lot No.", ReservationEntry."Package No.") then begin

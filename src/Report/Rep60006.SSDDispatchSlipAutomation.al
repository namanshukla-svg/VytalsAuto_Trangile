report 60006 "SSD Dispatch Slip Automation"
{
    ApplicationArea = All;
    ...
    dataset
    {
        ...
        dataitem("SSD Temp Dispatch Slip"; "SSD Temp Dispatch Pack") // "SSD Temp Dispatch Slip")
        {
    ...
    trigger OnPreReport()
    var
        DisppatchTempSlip: Record "SSD Temp Dispatch Pack"; //"SSD Temp Dispatch Slip";
    begin
        CompanyInfo.Get();
